	...
	<form id="formSubmit">
		...
		<div id="content">
			...
			<div style="position: relative;">
				...
				<button id="config" type="button" class="btn btn-info"
					style="position: absolute;right: 0px">Cấu
					hình
				</button>
            
				<h2 >thống kê công bố quốc tế của giảng viên</h2>
				...
				<div id="form"
					...
					<div
						...
						<label style="margin-right: 10px" for="">UserName: </label> <select
					...
					<div
						style="display: flex; flex-direction: row; align-items: center;">
						<label style="margin-right: 10px" for="">password: </label> <select
		...
		<input type="hidden" value="${tenfile}" id="tenfile" name="tenfile" />
		<input type="hidden" value="thống kê" id="report_name" name="report_name" />
...
function showConfig(data) {
	window.location.href = "${config}?tenfile="+data.tenfile+"&report_name ="+data.report_name;
}
